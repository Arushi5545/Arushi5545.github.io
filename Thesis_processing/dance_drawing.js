...
var p5_instance = function( p ){
    p.setup = function(){
        console.log("Setting up the canvas");
        var canvas = p.createCanvas(600, 600, P2D); //WHEN YOU NEED TO USE P3D, CHECK IN THE DOCUMENTATION FOR DEPTH SORT, DEPTH TESTING
...
// function setup() {
//   console.log("Setting up the canvas");
//   createCanvas(600, 600, P2D); //WHEN YOU NEED TO USE P3D, CHECK IN THE DOCUMENTATION FOR DEPTH SORT, DEPTH TESTING
